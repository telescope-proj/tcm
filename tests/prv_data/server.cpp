...
int main() {
    ...
    printf("Page size = %lu\n", tcm_internal::BASIC_PAGE_SIZE);
    printf("Hugepage size = %lu\n", tcm_internal::HUGE_PAGE_SIZE);
    printf("Locked memory limit = %lu\n", tcm_internal::MLOCK_LIMIT);
    ...
    {
        char str[]  = "TCM Hello World Application (Server)";
        char resp[] = "TCM Hello World Application (Client)";
